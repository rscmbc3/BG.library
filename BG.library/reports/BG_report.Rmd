---
title: 'BG_report for Dates: 2019-10-07 to 2019-10-10'
...
BGvalue_SummaryDaily<-summarizeData(allData, colName = "BG.Reading..mg.dL.",  timeStep = "day", 
                                    libraryPath = libraryPath,fromChange = fromChange,startDate = startDate,endDate = endDate)
...
BGHigh_Count<-summarizeData(allData, colName = "BG.Reading..mg.dL.", 
                            sumFuncs = "length",
                            filterCond = "data[data$BG.Reading..mg.dL.>150 & !is.na(data$BG.Reading..mg.dL.),]", libraryPath = libraryPath,fromChange = fromChange,startDate = startDate,endDate = endDate)
BGveryHigh_Count<-summarizeData(allData, colName = "BG.Reading..mg.dL.", 
                                sumFuncs = "length",
                                filterCond = "data[data$BG.Reading..mg.dL.>240 & !is.na(data$BG.Reading..mg.dL.),]", libraryPath = libraryPath,fromChange = fromChange,startDate = startDate,endDate = endDate)

BGLow_Count<-summarizeData(allData, colName = "BG.Reading..mg.dL.", 
                           sumFuncs = "length",
                           filterCond = "data[data$BG.Reading..mg.dL.<80 & !is.na(data$BG.Reading..mg.dL.),]", libraryPath = libraryPath,fromChange = fromChange,startDate = startDate,endDate = endDate)
